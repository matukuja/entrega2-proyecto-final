...
function agregarPedido(event) {
    ...
    if ((inputUnidades.value == "") || (inputUnidades.value == 0)) {
        ...
        if (indexExistencia == -1) {
            ...
            arrayPedidos[indexExistencia].unidades = arrayPedidos[indexExistencia].unidades + unidadesElegidas
        }
...
function disminuirPedido(idADisminuir) {
    ...
    arrayPedidos[indexADisminuir].unidades = arrayPedidos[indexADisminuir].unidades - 1
    if (arrayPedidos[indexADisminuir].unidades == 0) {
        eliminarPedido(idADisminuir)
    } else {
        actualizarLocalStoragePedidos()
        pintarTodosLosPedidos()
    }
...
function aumentarPedido(idAAumentar) {
    ...
    arrayPedidos[indexAAumentar].unidades = arrayPedidos[indexAAumentar].unidades + 1
    actualizarLocalStoragePedidos()
    pintarTodosLosPedidos()
}
